    ...
    this.activatedRoute.queryParams.subscribe(params => {
      ...
      if (cachedInfo) {
        ...
        this.habitacioneService.habitacion(this.idIngreso).subscribe((data: any) => {
          ...
          this.informacionPaciente.id_habitacion = data.id_habitacion.nombre_habitacion;
          localStorage.setItem('paciente_' + this.idIngreso, JSON.stringify(this.informacionPaciente));
        });
      }
    });
  }
